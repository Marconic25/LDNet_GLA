## Task 4 â€“ CS-25 comparison plots and summary

**Files:**
- Create: `light/tests/cs25_combo_plots.py`
- Create (generated): `light/results_cs25_combo/summary.md`

**Prerequisite:** Task 3 cluster jobs DONE â€” `results_cs25_combo/traces_W{10,20,30}.npz` and (optionally) the dp45 re-run of optimal in `results_cs25/traces_W{10,20,30}.npz`.
...
Generates in results_cs25_combo/:
  heatmap_clred_combo.png   â€” side-by-side CLred heatmap (optimal | combo)
  summary_lines_combo.png   â€” CLred vs Tg, two lines per W0
  summary.md                â€” per-cell comparison table
...
fig.suptitle('CS-25.341 â€” CLred comparison (DAMULT=3, R* per cell, no-explosion pick)', fontsize=9)
plt.tight_layout()
...
ax.set_title('CS-25 â€” one-step optimal (dashed) vs E2-combo (solid)')
...
# --- summary.md ---
md = [
    '# CS-25.341 â€” one-step optimal vs E2-combo (light/)\n\n',
...
Then from WSL (needs matplotlib, numpy only â€” no TF):
```bash
