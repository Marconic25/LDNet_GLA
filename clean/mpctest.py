...
U=80.;RHO=1.225;S=0.05;C=1.0;DT=0.002;q=0.5*RHO*U**2*S;TE=1.4
...
W0=20
o=run('open',W0)
print('open W0=%d: C_L=%.3f hddot=%.3f adot=%.4f'%(W0,o[0],o[1],np.rad2deg(o[2])),flush=True)
for nm,mode in [('prop','prop'),('mpc-N6','mpc')]:
    t0=time.time();r=run(mode,W0);el=time.time()-t0
    print('  %-7s: C_L %+6.1f%%  hddot %+7.1f%%  adot %+7.1f%%  flap %.1f  (%.0fs)'%(nm,(o[0]-r[0])/o[0]*100,(o[1]-r[1])/o[1]*100,(o[2]-r[2])/o[2]*100,r[3],el),flush=True)
