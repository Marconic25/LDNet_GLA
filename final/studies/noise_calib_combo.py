"""
Forked from light/noise/noise_calib_combo.py for the v6 campaign.
Derivation — what changed vs the light/ original:
  ...
  2. OUT: final/results_noise/A2_calib.npz instead of light/noise/results/.
Everything else (bias/gain sweep, clean + noisy spot-checks, npz schema) is
verbatim.
...
Output: final/results_noise/A2_calib.npz
...
OUT = os.path.join(paths.results_dir('noise'), 'A2_calib.npz')
...
print(f"# A2_calib [v6] | W{W0:g}/Tg{Tg:g} DAMULT={os.environ.get('DAMULT','1')} "
