"""
Forked from light/noise/plots_noise_white_combo.py for the v6 campaign.
...
Reads final/results_noise/W_combo.npz (arm='combo' records only). Generates
fig_ch3_noise_white.png in final/results_noise/ and the v6 image directory.
