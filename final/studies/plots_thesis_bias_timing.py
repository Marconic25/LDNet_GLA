"""
Forked from light/noise/plots_thesis_bias_timing.py for the v6 campaign.
Derivation — what changed vs the light/ original: DIR/IMG_DIR now come from
paths.py (final/results_noise, final/images) instead of light/noise/results/
and light/latex/Images/. Plot content/style (AGENTS.md) unchanged.
...
Reads final/results_noise/A2_calib.npz (arm='bias') and
final/results_noise/B2_timing.npz (arm='shift'). Generates
fig_ch3_bias_timing.png in final/results_noise/ and the v6 image directory.
