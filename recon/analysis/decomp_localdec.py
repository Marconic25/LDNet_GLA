...
--local-decoder lever (GatedLocalDecoder, additive local-correction SIREN
head near the flap), n=3 seeds. Same methodology as decomp_lw.py/
decomp_sepstate.py."""
import numpy as np
...
arms = {
    ...
    "local-decoder s0": "ms_coral_o10_local_s0_rom_cc060",
    "local-decoder s100": "ms_coral_o10_local_s100_rom_cc060",
    "local-decoder s200": "ms_coral_o10_local_s200_rom_cc060",
}
