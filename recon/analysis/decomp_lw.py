...
--loss-weight-mode flap lever (static geometric flap-proximity weight), n=3
seeds. Same methodology as decomp_rates.py."""
import numpy as np
...
arms = {
    ...
    "flap-lw s0": "ms_coral_o10_lw_s0_rom_cc060",
    "flap-lw s100": "ms_coral_o10_lw_s100_rom_cc060",
