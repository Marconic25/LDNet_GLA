...
for W in 10 20 30; do for T in 0.5 1.0 2.0; do
  W0=$W TG=$T TEND=3.0 SCHED=1 DAMULT=3 NGRID=15 PLOT=0 python3 -u mpc_gust.py
done; done
W0=11.46 TG=1.12 TEND=3.0 SCHED=1 DAMULT=3 NGRID=15 PLOT=0 python3 -u mpc_gust.py'
echo GRIDCHECK_DONE
