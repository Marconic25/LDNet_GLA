...
class OptimizationProblem():
    ...
    def compile(self):
        self.ag_train_loss = tf.function(self.loss_train) #trasformi in tensorflow function with autograph
        ...
        print('Tracing functions with autograph...') #compila 4 funzioni
        self.ag_train_loss()
        self.ag_train_grad()
    ...
    def get_gradient_and_loss(self, params_1d):  #calcolo gradiente:watch variabili -> loss -> gradiente.
...
#SciPy
#  ↓ propone nuovi parametri
#vector params_1d
# ↓
#update_variables()
#  ↓
#TensorFlow model aggiornato
#  ↓
#calcola loss + gradiente
#  ↓
#ritorna a SciPy